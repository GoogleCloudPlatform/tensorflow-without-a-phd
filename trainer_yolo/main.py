...
def main(argv):
    ...
    parser.add_argument('--hp-decay-restarts', default=3, type=int, choices=range(1, 7), help='Hyperparameter: learning rate decay restarts over the entire training. Only used when decay-type is "cosine-restarts". The learning rate always decays to its min value at the end of "iterations".')
