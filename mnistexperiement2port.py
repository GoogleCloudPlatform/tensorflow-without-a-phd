...
# after a "cosmetic" merge, 0.9932 max at the very end, below 0.993 at all times before that
# another run, 0.9936 max, nice cruise at 0.993 after 8000 iterations
# another run, 0.9938 max

# another "cosmetic" merge, this time just removing the default session initialisation
# 0.9931 max at 8100, 0.9930 at 4000 but stable around 0.9925 only
# 0.9933 max at 9300 but already at 0.9931 at 5300 and nice cruise at 0.993 from there
